<template>
  <div class="container mx-auto">
    <div class="grid md:grid-cols-10  col-span-2 gap-4 my-[3rem]">

      <div class="md:col-span-2 col-span-1 md:flex-col flex flex-wrap md:items-start items-center gap-3 ">
        <div class="text-[#333e48] font-[300] text-[14px]">
          Write by
        </div>
        <div class="text-[#333e48] font-[600]">
          John Doe
        </div>
        <div class="text-[#333e48] md:mt-2 font-[300] text-[14px]">
          When
        </div>
        <div class="text-[#333e48] font-[600] ">
          Apr 17th 2023
        </div>
        <div class="text-[#333e48] font-[300] text-[14px] mt-2">
          Category
        </div>
        <div class="flex justify-start gap-2 items-center mt-1  ">
          <button class="border border-[#333e48] text-[#333e48]  font-bold py-[3px] px-3 text-[12px] rounded">
            podcast
          </button>
          <button class="border border-[#333e48] text-[#333e48]  font-bold py-[3px] px-3 text-[12px] rounded">
            video
        ...
        <div>
          <div class="flex gap-2 items-center justify-start mt-1">
            <i class="fa-brands fa-facebook cursor-pointer text-[#333e48] text-xl"></i>
            <i class="fa-brands fa-linkedin cursor-pointer text-[#333e48] text-xl"></i>
            <i class="fa-brands fa-twitter cursor-pointer text-[#333e48] text-xl"></i>
          </div>
        </div>
      </div>
      <div class="md:col-span-8 col-span-1">
        <main>
          <div class="mb-4    relative h-[24rem]">
          ...
          <div class="  mt-12 text-gray-700  mx-auto text-lg leading-relaxed">
            ...
            <p class="pb-6">Dashwood contempt on mr unlocked resolved provided of of. Stanhill wondered it it welcomed
              ...
              convinced
              ye. Pleasant in to although as if differed horrible. Mirth his quick its set front enjoy hoped had there.
              Who
            ...
            <p class="pb-6">Breakfast agreeable incommode departure it an. By ignorant at on wondered relation. Enough
              ...
              invited
              elderly be. View him she roof tell her case has sigh. Moreover is possible he admitted sociable concerns.
              By
            ...
            <p class="pb-6">Detract yet delight written farther his general. If in so bred at dare rose lose good. Feel
              ...
              sufficient
              to unpleasant in in insensible favourable. Latter remark hunted enough vulgar say man. Sitting hearted on
              it
              without me.</p>
          </div>
        </main>
